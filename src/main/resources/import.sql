...
INSERT INTO "public"."swtvap_products" (id, category_id, code, name, description, price, stock, stock_min, status) VALUES (2, 1, 'PRODUCT-A00002', 'Madera de Pino', 'Madera de Pino', 500, 100, 10, 1);
INSERT INTO "public"."swtvap_products" (id, category_id, code, name, description, price, stock, stock_min, status) VALUES (3, 1, 'PRODUCT-A00003', 'Madera de Roble', 'Madera de Roble', 2000, 100, 10, 1);
...
INSERT INTO "public"."swtvap_orders_amounts" (id,order_id,name,amount) VALUES (2,2, 'ORDERAMOUNTEST',120.40);
INSERT INTO "public"."swtvap_orders_amounts" (id,order_id,name,amount) VALUES (3,3, 'ORDERAMOUNTEST',140.40);


INSERT INTO "public"."swtvap_orders_details" (id, order_id, product_id, quantity, unit_price, subtotal, discount_percentage, other_details, status) VALUES (1, 1, 1, 3, 25.99, 77.97, 10, 'OrderDetail 1 details', 1);
INSERT INTO "public"."swtvap_orders_details" (id, order_id, product_id, quantity, unit_price, subtotal, discount_percentage, other_details, status) VALUES (2, 1, 2, 2, 19.95, 39.90, 5, 'OrderDetail 2 details', 0);
INSERT INTO "public"."swtvap_orders_details" (id, order_id, product_id, quantity, unit_price, subtotal, discount_percentage, other_details, status) VALUES (3, 2, 3, 5, 12.50, 62.50, 0, 'OrderDetail 3 details', 1);
INSERT INTO "public"."swtvap_orders_details" (id, order_id, product_id, quantity, unit_price, subtotal, discount_percentage, other_details, status) VALUES (4, 2, 4, 1, 45.75, 45.75, 15, 'OrderDetail 4 details', 0);
INSERT INTO "public"."swtvap_orders_details" (id, order_id, product_id, quantity, unit_price, subtotal, discount_percentage, other_details, status) VALUES (5, 1, 5, 4, 30.20, 120.80, 8, 'OrderDetail 5 details', 1);
...
INSERT INTO "public"."swtvap_orders_transactions" (id, order_id, payment_method, amount, transaction_date) VALUES (2, 2, 'PayPal', '80.25', '2024-01-23');
INSERT INTO "public"."swtvap_orders_transactions" (id, order_id, payment_method, amount, transaction_date) VALUES (3, 3, 'Cash', '200.00', '2024-01-24');
INSERT INTO "public"."swtvap_orders_transactions" (id, order_id, payment_method, amount, transaction_date) VALUES (4, 1, 'Bank Transfer', '120.75', '2024-01-25');
INSERT INTO "public"."swtvap_orders_transactions" (id, order_id, payment_method, amount, transaction_date) VALUES (5, 2, 'Credit Card', '90.99', '2024-01-26');